package com.sojoline.base.toast;
...
public class CustomToast implements IToast {
	...
	public void makeTextShow(CharSequence text, long duration) {
		new CustomToast(mContext)
				...
				.setGravity(Gravity.BOTTOM, 0, 160).show();
	}

	@Override
	public void makeTextShow(@StringRes int resId, long duration) throws Resources.NotFoundException{
	...
	public static IToast makeText(Context context, CharSequence text, long duration) {
		return new CustomToast(context)
				.setText(text)
				.setDuration(duration)
				.setGravity(Gravity.BOTTOM, 0, 160);
	}
