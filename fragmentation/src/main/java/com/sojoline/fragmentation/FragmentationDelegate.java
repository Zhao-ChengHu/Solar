...
import com.sojoline.fragmentation.debug.DebugFragmentRecord;
import com.sojoline.fragmentation.debug.DebugHierarchyViewContainer;
        ...
        try {
            ...
            if (container != null) {
                ...
                if (preViewGroup != null) {
                    ...
                    preFragment.setOnFragmentDestoryViewListener(new OnFragmentDestroyViewListener() {
                        @Override
