...
class CompileTransform extends Transform{
    private Project project
    ClassPool classPool
    String applicationName;

    CompileTransform(Project project) {
    ...
    void transform(TransformInvocation transformInvocation) throws TransformException, InterruptedException, IOException {
        ...
        transformInvocation.inputs.each { TransformInput input ->
            ...
            input.directoryInputs.each { DirectoryInput directoryInput ->
                boolean isRegisterComponentAuto = project.extensions.compileBuild.isRegisterComponentAuto
    ...
    private void getRealApplicationName(Collection<TransformInput> inputs) {
        applicationName = project.extensions.compileBuild.applicationName
        if (applicationName == null || applicationName.isEmpty()) {
            throw new RuntimeException("you should set applicationName in compileBuild")
        }
    }
