package com.sojoline.basiclib.picker.wheel;
...
import com.sojoline.basiclib.picker.adapter.WheelViewAdapter;
import com.sojoline.basiclib.picker.listener.OnWheelChangedListener;
import com.sojoline.basiclib.picker.listener.OnWheelClickedListener;
import com.sojoline.basiclib.picker.listener.OnWheelScrollListener;
...
//		Log.d("liji.wheel", "visibleItems:" + visibleItems);
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(ContextCompat.getColor(getContext(), R.color.line_border));
		// 设置线宽
